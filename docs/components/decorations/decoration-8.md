...
<div class="datav-demo datav-demo--decoration" style="--datav-decoration-width: 190px; --datav-decoration-height: 190px;">
  <div class="datav-decoration-shell">
...
| `dur` | `number` | `3` | Rotation duration in seconds. |
...
| `outer-ring` | Wide rotating outer arc segments. |
