...
export class BorderBox4Element extends DatavElement {
  static override styles = css`
    :host {
      ...
      color: var(--dvk-color-primary, #36d9ff);
    }
    ...
    .content {
      ...
      height: 100%;
      min-height: 0;
      padding: var(--dvk-border-box-4-padding, var(--dvk-border-box-padding, var(--dvk-border-box-auto-padding)));
    }
  ...
  private readonly outerGlowId = `dvk-border-box-4-outer-glow-${this.instanceId}`
  private readonly softGlowId = `dvk-border-box-4-soft-glow-${this.instanceId}`
  private readonly lineGlowId = `dvk-border-box-4-line-glow-${this.instanceId}`
  ...
  override firstUpdated(): void {
    this.emit('dvk-ready', { tagName: 'dvk-border-box-4' })
  }
  ...
  private createFilterIds(suffix: string): BorderBox4FilterIds {
    return {
      ...
      clipId: `dvk-border-box-4-clip-${this.instanceId}-${suffix}`,
    }
  }
