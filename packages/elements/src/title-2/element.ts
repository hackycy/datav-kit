...
export class Title2Element extends DatavElement {
  static override styles = css`
    :host {
      ...
      min-width: 0;
      min-height: 0;
      color: var(--dvk-title-2-title-color, #effcff);
    }
    ...
    .title {
      ...
      max-width: 100%;
      padding: 0 var(--dvk-title-2-title-gap, 0.8em);
      overflow: hidden;
      color: var(--dvk-title-2-title-color, #effcff);
      font: var(--dvk-title-2-title-font, 700 22px/1 'Microsoft YaHei', 'PingFang SC', 'Noto Sans CJK SC', Arial, sans-serif);
      letter-spacing: var(--dvk-title-2-title-letter-spacing, 0.09em);
      text-align: center;
      white-space: nowrap;
      text-overflow: ellipsis;
      text-shadow: 0 0 6px var(--dvk-title-2-title-glow, rgba(87, 243, 255, 0.16));
    }
    ...
    .edge-dot {
      ...
      height: 3px;
      margin-top: -1px;
      background: var(--dvk-title-2-edge-dot, rgba(87, 243, 255, 0.72));
      box-shadow: 0 0 7px var(--dvk-title-2-edge-dot-glow, rgba(87, 243, 255, 0.18));
    }
  ...
  override render(): unknown {
    ...
    const railOpacity = this.resolveOpacity('--dvk-title-2-rail-opacity', 0.36)
    const accentOpacity = this.resolveOpacity('--dvk-title-2-accent-opacity', 0.68)
    ...
    return html`
      ...
      <div part="content" class="content">
        <div
          part="title"
          class="title"
          style=${`--dvk-title-2-edge-dot: ${withAlpha(primary, 0.72)}; --dvk-title-2-edge-dot-glow: ${withAlpha(primary, 0.18)}`}
        >
